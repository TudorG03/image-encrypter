...
public class C05ApiClient {
    ...
    public void createJob(String jobId, Long userId, String operation, String mode, String keyHex, String ivHex) {
        restClient.post()
                .uri("/jobs")
                .contentType(MediaType.APPLICATION_JSON)
                .body(Map.of(
    ...
    public List<JobResponse> listJobsByUser(Long userId) {
        return restClient.get()
